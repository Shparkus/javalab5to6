...
- group_counting_by_full_name : сгруппировать элементы коллекции по значению поля fullName, вывести количество элементов в каждой группе
...
- filter_by_full_name fullName : вывести элементы, значение поля fullName которых равно заданному
